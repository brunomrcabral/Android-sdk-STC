...
public final class ModelTipoOcorrencias {

    public ModelTipoOcorrencias() {}

    // Schema
    public static abstract class ModelTipoOcorrenciasSchema implements BaseColumns {
        public static final String TABLE_NAME = "tipocorrencias";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelTipoOcorrenciasSchema.TABLE_NAME + " (" +
                    ModelTipoOcorrenciasSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelTipoOcorrenciasSchema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelTipoOcorrenciasSchema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelTipoOcorrenciasSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelTipoOcorrenciasSchema.TABLE_NAME +
                " VALUES(" +
