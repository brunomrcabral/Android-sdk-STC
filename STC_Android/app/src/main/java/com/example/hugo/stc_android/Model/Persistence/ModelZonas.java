...
public final class ModelZonas {

    public ModelZonas() {}

    // Schema
    public static abstract class ModelZonasSchema implements BaseColumns {
        public static final String TABLE_NAME = "zonas";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelZonasSchema.TABLE_NAME + " (" +
                    ModelZonasSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelZonasSchema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelZonasSchema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelZonasSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelZonasSchema.TABLE_NAME +
                " VALUES(" +
