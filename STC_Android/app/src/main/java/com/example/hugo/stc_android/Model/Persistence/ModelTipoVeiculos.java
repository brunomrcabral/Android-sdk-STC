...
public final class ModelTipoVeiculos {

    public ModelTipoVeiculos() {}

    // Schema
    public static abstract class ModelTipoVeiculosSchema implements BaseColumns {
        public static final String TABLE_NAME = "tipveiculos";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelTipoVeiculosSchema.TABLE_NAME + " (" +
                    ModelTipoVeiculosSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelTipoVeiculosSchema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelTipoVeiculosSchema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelTipoVeiculosSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelTipoVeiculosSchema.TABLE_NAME +
                " VALUES(" +
