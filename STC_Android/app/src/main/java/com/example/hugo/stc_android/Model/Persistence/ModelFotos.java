...
public final class ModelFotos {

    public ModelFotos() {}

    // Schema
    public static abstract class ModelFotosSchema implements BaseColumns {
        public static final String TABLE_NAME = "fotos";

        public static final String COLUMN_CODIGO_CONTRA_ORDENACAO = "codigo_contra_ordenacao";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelFotosSchema.TABLE_NAME + " (" +
                    ModelFotosSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelFotosSchema.COLUMN_CODIGO_CONTRA_ORDENACAO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelFotosSchema.COLUMN_LINK + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelFotosSchema.COLUMN_DATA + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelFotosSchema.COLUMN_ENVIADO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelFotosSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelFotosSchema.TABLE_NAME +
                " VALUES(" +
