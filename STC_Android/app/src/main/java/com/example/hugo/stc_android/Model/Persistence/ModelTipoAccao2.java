...
public final class ModelTipoAccao2 {

    public ModelTipoAccao2() {}

    // Schema
    public static abstract class ModelTipoAccao2Schema implements BaseColumns {
        public static final String TABLE_NAME = "tipoaccao2";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelTipoAccao2Schema.TABLE_NAME + " (" +
                    ModelTipoAccao2Schema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelTipoAccao2Schema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelTipoAccao2Schema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelTipoAccao2Schema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelTipoAccao2Schema.TABLE_NAME +
                " VALUES(" +
