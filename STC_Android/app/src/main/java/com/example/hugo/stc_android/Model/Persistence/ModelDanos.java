...
public final class ModelDanos {

    public ModelDanos() {}

    // Schema
    public static abstract class ModelDanosSchema implements BaseColumns {
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelDanosSchema.TABLE_NAME + " (" +
                    ModelDanosSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelDanosSchema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelDanosSchema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelDanosSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelDanosSchema.TABLE_NAME +
                " VALUES(" +
