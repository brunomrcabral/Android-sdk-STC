...
public final class ModelViaComunicacoes {

    public ModelViaComunicacoes() {}

    // Schema
    public static abstract class ModelViaComunicacoesSchema implements BaseColumns {
        public static final String TABLE_NAME = "viacomunicacaos";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelViaComunicacoesSchema.TABLE_NAME + " (" +
                    ModelViaComunicacoesSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelViaComunicacoesSchema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelViaComunicacoesSchema.COLUMN_LABEL + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelViaComunicacoesSchema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelViaComunicacoesSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelViaComunicacoesSchema.TABLE_NAME +
                " VALUES(" +
