...
public final class ModelTipoDocumentos {

    public ModelTipoDocumentos() {}

    // Schema
    public static abstract class ModelTipoDocumentosSchema implements BaseColumns {
        public static final String TABLE_NAME = "tipodocumentos";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelTipoDocumentosSchema.TABLE_NAME + " (" +
                    ModelTipoDocumentosSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelTipoDocumentosSchema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelTipoDocumentosSchema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelTipoDocumentosSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelTipoDocumentosSchema.TABLE_NAME +
                " VALUES(" +
