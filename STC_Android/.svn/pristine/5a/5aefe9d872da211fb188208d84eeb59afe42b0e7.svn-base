...
import com.example.hugo.stc_android.Model.AsyncOperations.SynchronizeInfo;
import com.example.hugo.stc_android.R;
import com.example.hugo.stc_android.ViewController.Dialogs.PasswordDialog;
 ...
 * Created by Hugo
 */
public class BaseActivity extends AppCompatActivity implements DialogListeners {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.drawer_options);
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                PasswordDialog passwdFragment = new PasswordDialog();
                passwdFragment.show(getSupportFragmentManager(), "passwDialog");
                break;
            case 3:
                Intent intent3 = new Intent(this, PrintersActivity.class);
