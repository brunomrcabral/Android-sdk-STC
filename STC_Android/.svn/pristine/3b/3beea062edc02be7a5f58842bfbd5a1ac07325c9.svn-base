...
public final class ModelCores {

    public ModelCores() {}

    // Schema
    public static abstract class ModelCoresSchema implements BaseColumns {
        public static final String TABLE_NAME = "cors";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelCoresSchema.TABLE_NAME + " (" +
                    ModelCoresSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelCoresSchema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelCoresSchema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelCoresSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelCoresSchema.TABLE_NAME +
                " VALUES(" +
