...
public final class ModelMotivos {

    public ModelMotivos() {}

    // Schema
    public static abstract class ModelMotivosSchema implements BaseColumns {
        public static final String TABLE_NAME = "motivos";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelMotivosSchema.TABLE_NAME + " (" +
                    ModelMotivosSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelMotivosSchema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelMotivosSchema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelMotivosSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelMotivosSchema.TABLE_NAME +
                " VALUES(" +
