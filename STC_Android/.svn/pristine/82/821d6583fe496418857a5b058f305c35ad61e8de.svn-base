...
public final class ModelReboques {

    public ModelReboques() {}

    // Schema
    public static abstract class ModelReboquesSchema implements BaseColumns {
        public static final String TABLE_NAME = "reboques";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelReboquesSchema.TABLE_NAME + " (" +
                    ModelReboquesSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelReboquesSchema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelReboquesSchema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelReboquesSchema.COLUMN_MATRICULA + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelReboquesSchema.COLUMN_MODELO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelReboquesSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelReboquesSchema.TABLE_NAME +
                " VALUES(" +
