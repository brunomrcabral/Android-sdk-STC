...
public final class ModelTipoFigura {

    public ModelTipoFigura() {}

    // Schema
    public static abstract class ModelTipoFiguraSchema implements BaseColumns {
        public static final String TABLE_NAME = "tipofigura";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelTipoFiguraSchema.TABLE_NAME + " (" +
                    ModelTipoFiguraSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelTipoFiguraSchema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelTipoFiguraSchema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelTipoFiguraSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelTipoFiguraSchema.TABLE_NAME +
                " VALUES(" +
