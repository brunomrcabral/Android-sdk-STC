...
public final class ModelPaises {

    public ModelPaises() {}

    // Schema
    public static abstract class ModelPaisesSchema implements BaseColumns {
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelPaisesSchema.TABLE_NAME + " (" +
                    ModelPaisesSchema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelPaisesSchema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelPaisesSchema.COLUMN_NOME + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelPaisesSchema.COLUMN_SIGLA + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelPaisesSchema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelPaisesSchema.TABLE_NAME +
                " VALUES(" +
