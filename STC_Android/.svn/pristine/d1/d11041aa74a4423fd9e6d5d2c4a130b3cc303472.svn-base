...
public final class ModelTipoAccao1 {

    public ModelTipoAccao1() {}

    // Schema
    public static abstract class ModelTipoAccao1Schema implements BaseColumns {
        public static final String TABLE_NAME = "tipoaccao1";
    ...
    public static final String SQL_CREATE_QUERY =
            "CREATE TABLE IF NOT EXISTS " + ModelTipoAccao1Schema.TABLE_NAME + " (" +
                    ModelTipoAccao1Schema._ID + DBUtils.TYPE_INTEGER + DBUtils.PRIMARY_KEY + DBUtils.COMMA_SEP +
                    ModelTipoAccao1Schema.COLUMN_CODIGO + DBUtils.TYPE_TEXT + DBUtils.COMMA_SEP +
                    ModelTipoAccao1Schema.COLUMN_DESCRICAO + DBUtils.TYPE_TEXT +
            " )";

    public static final String SQL_DELETE_QUERY =
            "DROP TABLE IF EXISTS " + ModelTipoAccao1Schema.TABLE_NAME;
    ...
    public static String sqlInsertQuery(List<String> recordValues) {
        ...
        return "INSERT INTO " + ModelTipoAccao1Schema.TABLE_NAME +
                " VALUES(" +
